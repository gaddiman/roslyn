...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.ProjectSystem
{
    internal sealed class VisualStudioProject
    {
        ...
        public string FilePath
        {
            ...
            set
            {
                ChangeProjectProperty(
                    ...
                    w => w.OnProjectNameChanged(Id, _projectUniqueName, value));
            }
        }
        ...
        private sealed class DocumentCollection
        {
            ...
            /// </summary>
            private readonly List<DocumentInfo> _documentsAddedInBatch = new List<DocumentInfo>();
            ...
            public void RemoveFile(string fullPath)
            {
                ...
                lock (_project._gate)
                {
                    ...
                    {
                        var documentsRemoved = _documentsAddedInBatch.RemoveAll(d => d.Id == documentId);
                        Contract.ThrowIfFalse(documentsRemoved == 1);
                    }
                }
            }
